...
my_filename = "test1_GBAnisotropy1MisAng3"
...
[Materials]
  [./CuGrGranisotropic]
    ...
    delta_theta_HAB = 15
    GBsigma_HAB = 1.0 # from [1] J. Wang, I.J. Beyerlein, Metall Mater Trans A. 43 (2012) 3556–3569.
    GBmob_HAB = 2.5e-6

    TT1_sigma = 0.1019 # from MD by He
    CT1_sigma = 0.0616 # from MD by He
