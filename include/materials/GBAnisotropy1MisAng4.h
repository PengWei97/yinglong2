...
// GBAnisotropy1MisAng4 -- This version of the GB energy can be introduced based on an interpolation function, and additionally assumes that the GB mobility is proportional to the GB energy. Meanwhile, add the function to identify and set the energy and mobility of twin boundaries.

class GBAnisotropy1MisAng4 : public GBAnisotropy1MisAngBase
{
public:
  static InputParameters validParams();  
  GBAnisotropy1MisAng4(const InputParameters & parameters);
