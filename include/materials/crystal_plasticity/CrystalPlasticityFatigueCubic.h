...
class CrystalPlasticityFatigueCubic;

/**
 * CrystalPlasticityFatigueCubic uses the multiplicative decomposition of the
...
class CrystalPlasticityFatigueCubic : public CrystalPlasticityStressUpdateBase
{
public:
  static InputParameters validParams();

  CrystalPlasticityFatigueCubic(const InputParameters & parameters);
