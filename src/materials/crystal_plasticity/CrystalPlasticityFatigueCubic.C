...
#include "CrystalPlasticityFatigueCubic.h"
#include "libmesh/int_range.h"

registerMooseObject("yinglongApp", CrystalPlasticityFatigueCubic);

InputParameters
CrystalPlasticityFatigueCubic::validParams()
{
  InputParameters params = CrystalPlasticityStressUpdateBase::validParams();
  params.addClassDescription("Kalidindi version of homogeneous crystal plasticity considering fatigue load.");
  params.addParam<Real>("r", 1.0, "Latent hardening coefficient"); // q
  params.addParam<Real>("h", 541.5, "hardening constants"); // h_0
  params.addParam<Real>("t_sat", 109.8, "saturated slip system strength"); // g_{sat}
  params.addParam<Real>("gss_a", 2.5, "coefficient for hardening"); // a
  params.addParam<Real>("ao", 0.001, "slip rate coefficient"); // a reference slip rate gamma_0^{\cdot}
  params.addParam<Real>("xm", 0.1, "exponent for slip rate"); // slip rate sensitivity parameter m
  params.addParam<Real>("gss_initial", 60.8, "initial lattice friction strength of the material"); // g_0
...
CrystalPlasticityFatigueCubic::CrystalPlasticityFatigueCubic(
...
void
CrystalPlasticityFatigueCubic::initQpStatefulProperties()
{
...
void
CrystalPlasticityFatigueCubic::setInitialConstitutiveVariableValues()
{
...
void
CrystalPlasticityFatigueCubic::setSubstepConstitutiveVariableValues()
{
...
bool
CrystalPlasticityFatigueCubic::calculateSlipRate()
{
  for (const auto i : make_range(_number_slip_systems))
  {
...
void
CrystalPlasticityFatigueCubic::calculateEquivalentSlipIncrement(
...
void
CrystalPlasticityFatigueCubic::calculateConstitutiveSlipDerivative(
...
bool
CrystalPlasticityFatigueCubic::areConstitutiveStateVariablesConverged()
{
...
void
CrystalPlasticityFatigueCubic::updateSubstepConstitutiveVariableValues()
{
  // Would also set substepped dislocation densities here if included in this model
...
void
CrystalPlasticityFatigueCubic::cacheStateVariablesBeforeUpdate()
{
  _slip_resistance_before_update = _slip_resistance[_qp];
}

void
CrystalPlasticityFatigueCubic::calculateStateVariableEvolutionRateComponent()
{
  for (const auto i : make_range(_number_slip_systems))
  {
...
bool
CrystalPlasticityFatigueCubic::updateStateVariables()
{
