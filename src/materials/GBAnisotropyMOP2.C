...
#include "GBAnisotropyMOP2.h"
#include "MooseMesh.h"

#include <fstream>

registerMooseObject("yinglongApp", GBAnisotropyMOP2);

InputParameters
GBAnisotropyMOP2::validParams()
{
...
GBAnisotropyMOP2::GBAnisotropyMOP2(const InputParameters & parameters)
  : Material(parameters),
...
void
GBAnisotropyMOP2::computeQpProperties()
{
...
void 
GBAnisotropyMOP2::getGBAnisotropyFromFile()
{
...
void
GBAnisotropyMOP2::computerModelParameter()
{
  Real sigma_init;
  Real g2 = 0.0;
  Real f_interf = 0.0;
