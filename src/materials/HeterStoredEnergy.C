...
#include "HeterStoredEnergy.h"
#include "GrainTrackerInterface.h"

registerMooseObject("yinglongApp", HeterStoredEnergy);

InputParameters
HeterStoredEnergy::validParams()
{
...
HeterStoredEnergy::HeterStoredEnergy(const InputParameters & parameters)
  : Material(parameters),
...
void
HeterStoredEnergy::computeQpProperties()
{
  Real SumEtai2 = 0.0;
