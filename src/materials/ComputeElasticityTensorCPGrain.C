// Nicolo Grilli  ADSC Singapore 3 October 2020ss
// 

#include "ComputeElasticityTensorCPGrain.h"
#include "RotationTensor.h"

registerMooseObject("yinglongApp", ComputeElasticityTensorCPGrain);
...
ComputeElasticityTensorCPGrain::computeQpElasticityTensor()
{
  ...
  // Apply temperature dependence on _Cijkl and save results on _Temp_Cijkl
...
// Temperature dependence of the elasticity tensor always referred to room temperature
void
